...
When creating documentation, reference these skills:
- `skill://content-research-writer` — Research-backed content creation
- `skill://changelog-generator` — Automated changelog generation
- `skill://docx` — Word document generation
- `skill://pdf` — PDF generation
- `skill://pptx` — Presentation generation