...
When working on Rust projects, reference these skills for specialized knowledge:
- `skill://nixify` — Generate Nix flake for Rust project setup
- `skill://webapp-testing` — Testing patterns for web applications