...
When working on Python projects, reference these skills for specialized knowledge:
- `skill://nixify` — Generate Nix flake for Python project setup
- `skill://docx` — Word document generation
- `skill://xlsx` — Excel spreadsheet generation
- `skill://pdf` — PDF document generation