...

{
  ...
  nix.settings = {
    ...
    # Warn about dirty git trees - Removed to avoid potential issues
    # warn-dirty = false; 
  ...
  # Automatic garbage collection - DISABLED (using nh instead)
  # nix.gc = {
  #   automatic = true;
  #   dates = "weekly";
  ...
  systemd = {
    ...
    # User service limits - REPLACED extraConfig
    settings.Manager = {
